/**
 * VISUAL Sound System - Types
 * 
 * Identité sonore officielle de VISUAL
...
export type SoundName =
  ...
  | "win"         // Gain utilisateur (~1.2s) - argent, VISUpoints, TOP
...
export const SOUND_CONFIGS: Record<SoundName, SoundConfig> = {
  spark: {
    name: "spark",
    description: "VISUAL Spark - Jingle principal d'ouverture",
    duration: 2.0,
    volume: 0.6,
  },
  pulse: {
    name: "pulse",
    description: "VISUAL Pulse - Mini notification",
    duration: 0.6,
    volume: 0.4,
  },
  win: {
    name: "win",
    description: "VISUAL Win - Gain utilisateur",
    duration: 1.2,
    volume: 0.5,
  },
  boost: {
    name: "boost",
    description: "VISUAL Boost - Projet populaire/tendance",
    duration: 1.4,
    volume: 0.5,
  },
  click: {
