          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2 pt-2">
              ...
              {(["creator", "contributor"] as const).map((type) => {
                const paid = type === "creator" ? data?.cautions?.creatorPaid : data?.cautions?.contributorPaid
                const label = type === "creator" ? "Createur" : "Contributeur"
        ...
        <CardContent className="p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-white/35">
            ...
            <div className="flex items-start gap-2">
              ...
              <span>{"Gains non garantis. Les retours dependent de la performance des projets soutenus. VIXUAL n'est pas un jeu de hasard."}</span>
            </div>
          </div>
        </CardContent>
      </Card>
