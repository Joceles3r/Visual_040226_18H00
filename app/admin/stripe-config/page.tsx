      ...
      <div className="relative flex items-center gap-2">
        <div className="relative flex-1">
          <input
            ...
            className="w-full bg-slate-900/80 border border-white/10 rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-amber-500/60 focus:ring-1 focus:ring-amber-500/30 font-mono pr-10"
          />
          <button
            type="button"
...
export default function StripeConfigPage() {
  ...
  const handleToggleMode = async () => {
    ...
    if (!confirm(`Basculer en mode ${newMode.toUpperCase()} ?\n\n${newMode === "live" ? "ATTENTION : Les transactions seront RÉELLES." : "Retour en mode test — aucune transaction réelle."}`)) {
      return
    }
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white/40 text-sm mt-0.5">
                  {isLiveMode
                    ? "Transactions financières réelles en cours"
        ...
        <Card className="bg-slate-900/60 border-emerald-500/20">
          <CardHeader className="pb-4">
            <CardTitle className="text-base text-emerald-300 flex items-center gap-2">
              ...
              Clés TEST — Développement et Validation
            </CardTitle>
          ...
          <CardContent className="space-y-5">
            ...
            <div className="p-4 rounded-xl bg-amber-500/10 border border-amber-500/20 space-y-2">
              ...
              <code className="text-amber-200/80 text-xs block bg-black/30 px-3 py-2 rounded-lg break-all">
      ...
      <Card className="bg-slate-900/40 border-white/5">
        ...
        <CardContent>
          <ol className="space-y-2 text-xs text-white/40">
            ...
            <li className="flex gap-3"><span className="text-amber-400 font-bold shrink-0">5.</span> Quand VIXUAL est en production, ajoutez les clés LIVE et basculez le mode via le bouton ci-dessus.</li>
          </ol>
        </CardContent>
      </Card>
